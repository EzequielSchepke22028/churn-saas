...
function Login() {
  ...
  const { login, error, loading, initialize, isAuthenticated } = useAuthStore()

  // Initialize on load to check existing token
  useEffect(() => {
    initialize()
  }, [initialize])
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      // For now, before React Router is fully set up, we use window.location
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-12 bg-canvas">
      
      {/* LEFT PANEL: Dark premium Vercel-style branding and real metric simulation */}
      <div className="hidden md:flex md:col-span-5 bg-ink text-white flex-col justify-between p-12 border-r border-border/10 select-none">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-black/40 border border-border/10 rounded-lg p-5 shadow-raised space-y-4">
            <div className="flex items-center justify-between border-b border-border/10 pb-3">
              ...
              {/* Inverted danger badge for dark backgrounds */}
            ...
            <div className="space-y-3 font-mono">
              ...
              <div className="flex justify-between text-xs">
                ...
                {/* geist Mono & tabular-nums for financial alignment */}
              ...
              <div className="border-t border-border/10 pt-3 flex items-center justify-between">
                ...
                <span className="text-xl font-bold text-danger font-mono tabular-nums animate-fade-in">
                  86.87%
                </span>
              </div>
            </div>
      ...
      {/* RIGHT PANEL: Clean, elegant login form on a sutil light canvas */}
      <div className="col-span-1 md:col-span-7 flex flex-col justify-center items-center p-6 md:p-16">
